    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        >
          <Link
            href="/register"
            className="h-12 px-8 rounded-xl bg-accent text-accent-foreground text-base font-bold hover:opacity-90 active:opacity-80 transition-opacity"
          >
            Start for free
          </Link>
          <a
            href="#how-it-works"
            className="h-12 px-8 rounded-xl border border-white/10 text-white text-base font-medium hover:bg-white/5 transition-colors"
          >
            See how it works
          </a>
        </motion.div>
