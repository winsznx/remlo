...
export const hyperspeedPresets = {
  one: {
    ...
    brokenLinesWidthPercentage: 0.1,
    brokenLinesLengthPercentage: 0.5,
    lightStickWidth: [0.12, 0.5] as Range,
    lightStickHeight: [1.3, 1.7] as Range,
    movingAwaySpeed: [60, 80] as Range,
    movingCloserSpeed: [-120, -160] as Range,
    carLightsLength: [400 * 0.03, 400 * 0.2] as Range,
    carLightsRadius: [0.05, 0.14] as Range,
    carWidthPercentage: [0.3, 0.5] as Range,
    carShiftX: [-0.8, 0.8] as Range,
    carFloorSeparation: [0, 5] as Range,
    colors: {
      roadColor: 0x080808,
      islandColor: 0x0a0a0a,
      background: 0x000000,
  ...
  two: {
    ...
    movingAwaySpeed: [60, 80] as Range,
    movingCloserSpeed: [-120, -160] as Range,
    carLightsLength: [400 * 0.05, 400 * 0.15] as Range,
    carLightsRadius: [0.05, 0.14] as Range,
    carWidthPercentage: [0.3, 0.5] as Range,
    carShiftX: [-0.2, 0.2] as Range,
    carFloorSeparation: [0.05, 1] as Range,
    colors: {
      roadColor: 0x080808,
      islandColor: 0x0a0a0a,
      background: 0x000000,
  ...
  three: {
    ...
    brokenLinesWidthPercentage: 0.1,
    brokenLinesLengthPercentage: 0.5,
    lightStickWidth: [0.02, 0.05] as Range,
    lightStickHeight: [0.3, 0.7] as Range,
    movingAwaySpeed: [20, 50] as Range,
    movingCloserSpeed: [-150, -230] as Range,
    carLightsLength: [400 * 0.05, 400 * 0.2] as Range,
    carLightsRadius: [0.03, 0.08] as Range,
    carWidthPercentage: [0.1, 0.5] as Range,
    carShiftX: [-0.5, 0.5] as Range,
    carFloorSeparation: [0, 0.1] as Range,
    colors: {
      roadColor: 0x080808,
      islandColor: 0x0a0a0a,
      background: 0x000000,
...
} satisfies Record<string, HyperspeedOptions>
...
const Hyperspeed: FC<HyperspeedProps> = ({ effectOptions = {} }) => {
  ...
  return <div ref={hyperspeed} className={styles.lights} />
}
